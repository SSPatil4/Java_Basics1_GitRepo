...
// merging maps
    public static void main(String[] args) {
        ...
        HashMap<String, Integer> subjectToStudentCountMap3 = new HashMap<>(subjectToStudentCountMap2);

        subjectToStudentCountMap1.forEach((key, value) -> subjectToStudentCountMap3.merge(key, value, (v1, v2) -> v1 + v2));
